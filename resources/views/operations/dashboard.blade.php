                ...
                <div class="col">
                    <div class="card radius-10 overflow-hidden">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-4">
                                <div>
                                    <p class="text-black">Received Payments</p>
                        ...
                        <div class="support-list p-3 mb-3">
                            <div class="d-flex align-items-top">
                                ...
                                <div class="ps-2">
                                    ...
                                    <p class="mb-0 font-13 text-secondary">My item doesn't ship to correct address. Please
                                        check It Proper</p>
                                </div>
                            </div>
                            <hr />
                            <div class="d-flex align-items-top">
                                ...
                                <div class="ps-2">
                                    ...
                                    <p class="mb-0 font-13 text-secondary">You shipped different color, I need it to be
                                        changed</p>
                                </div>
                            </div>
                            <hr />
                            <div class="d-flex align-items-top">
                                ...
                                <div class="ps-2">
                                    ...
                                    <p class="mb-0 font-13 text-secondary">Can you please refund my money. I don't want to
                                        wait anymore</p>
                                </div>
                            </div>
                            <hr />
                            <div class="d-flex align-items-top">
                                ...
                                <div class="ps-2">
                                    ...
                                    <p class="mb-0 font-13 text-secondary">Please return my phone. it is not iPhon7. I send
                                        you many request.</p>
                                </div>
                            </div>
                            <hr />
                            <div class="d-flex align-items-top">
                                ...
                                <div class="ps-2">
                                    ...
                                    <p class="mb-0 font-13 text-secondary">Hello, I need admin template product. how can i
                                        purchase?</p>
                                </div>
                            </div>
                            <hr />
